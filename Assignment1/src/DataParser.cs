...
namespace Application1
{
    ...
    {
        Writer w=new Writer();
        private bool DateCheck(string date){                  //DateCheck method Signature
            try{
        ...
        public void DataCollect(string filepath)               //DataCollect method signature
        {
            try{
        ...
        private void ParseLines(string line1, string line2)                   //ParseLines method signature
        {
